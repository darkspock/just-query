...
namespace JustQuery\Tests\Integration\Mysql;

use JustQuery\Query\Query;

final class SelectQueryTest extends MysqlTestCase
{
    ...
    public function testWhereOperator(): void
    {
        ...
        self::assertCount(2, $rows); // Alice(30), Charlie(35)
    }
    ...
    public function testWhereLike(): void
    {
        ...
        self::assertCount(4, $rows); // Eve has NULL email
    }
    ...
    public function testWhereBetween(): void
    {
        ...
        self::assertCount(3, $rows); // Bob(25), Diana(28), Alice(30)
    }
    ...
    public function testWhereAndOr(): void
    {
        ...
        self::assertCount(3, $rows); // Alice(1500), Diana(3200), Eve
    }
    ...
    public function testOrderBy(): void
    {
        ...
        self::assertSame('Eve', $rows[0]['name']);   // 22
        self::assertSame('Charlie', $rows[4]['name']); // 35
    }
    ...
    public function testDistinct(): void
    {
        ...
        self::assertCount(2, $rows); // 0 and 1
    }
    ...
    public function testGroupByHaving(): void
    {
        ...
        self::assertCount(2, $rows); // user 1 (2 orders) and user 4 (2 orders)
    }
