...
final class DMLTest extends MysqlTestCase
{
    ...
    public function testInsertAndGetLastId(): void
    {
        ...
        $id1 = $this->getDb()->getLastInsertID();

        $this->getDb()->createCommand()->insert('test_users', [
            'name' => 'Second',
        ])->execute();

        $id2 = $this->getDb()->getLastInsertID();
    ...
    public function testUpdateMultipleRows(): void
    {
        ...
        self::assertSame(3, $inactiveCount); // Charlie was already 0, plus Alice(30) and Charlie(35)
    }
    ...
    public function testDeleteWithOperator(): void
    {
        ...
        $count = (new Query($this->getDb()))->from('test_users')->count('*');
        self::assertSame(4, $count); // Eve(22) deleted
    }
