...
use JustQuery\Constant\IndexType;
use JustQuery\Constant\PseudoType;
use JustQuery\Constant\ReferentialAction;
use JustQuery\Exception\Exception;
use InvalidArgumentException;
use JustQuery\Exception\InvalidCallException;
...
use JustQuery\Query\DataReaderInterface;
use JustQuery\Query\QueryInterface;
use JustQuery\QueryBuilder\DMLQueryBuilderInterface;
...
interface CommandInterface
{
     ...
     *     ],
     *     [
     *         'visits' => new \JustQuery\Expression\Expression('visits + 1'),
     *     ],
     *     $params,
     * );
     * ```
     ...
     * $db->createCommand()->increment('users', 'balance', 50.00, ['id' => 1], ['last_deposit' => now()])->execute();
     * ```
     *
     * @param string $table The table name.
     * @param string $column The column to increment.
     * @param int|float $amount The amount to increment by. Defaults to 1.
     * @param array<string, mixed>|string $condition The WHERE condition.
     ...
     * @param int|float $amount The amount to decrement by. Defaults to 1.
     * @param array<string, mixed>|string $condition The WHERE condition.
     * @param array<string, mixed> $extra Additional columns to update.
     */
    ...
    /**
     * Increments multiple columns at once.
     *
     * ```php
     ...
     *
     * @param string $table The table name.
     * @param array<string, int|float> $columns Column => amount pairs.
     * @param array<string, mixed>|string $condition The WHERE condition.
     * @param array<string, mixed> $extra Additional columns to update.
     */
