...
namespace FastPHP\QueryBuilder\Command;
...
use FastPHP\QueryBuilder\Constant\IndexType;
use FastPHP\QueryBuilder\Constant\PseudoType;
use FastPHP\QueryBuilder\Constant\ReferentialAction;
use FastPHP\QueryBuilder\Exception\Exception;
use InvalidArgumentException;
use FastPHP\QueryBuilder\Exception\InvalidCallException;
...
use FastPHP\QueryBuilder\Query\DataReaderInterface;
use FastPHP\QueryBuilder\Query\QueryInterface;
use FastPHP\QueryBuilder\QueryBuilder\DMLQueryBuilderInterface;
...
interface CommandInterface
{
     ...
     *     ],
     *     [
     *         'visits' => new \FastPHP\QueryBuilder\Expression\Expression('visits + 1'),
     *     ],
     *     $params,
     * );
     * ```
