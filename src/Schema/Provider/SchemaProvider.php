...
final class SchemaProvider
{
    ...
    /**
     * Returns column metadata for write filtering (computed, readOnly, autoIncrement).
     *
     * @return array{computed: string[], readOnly: string[], autoIncrement: string[]}
     */
    public function getWriteExclusions(string $tableName): array
    {
        $schema = $this->getTableSchema($tableName);
        if ($schema === null) {
            return ['computed' => [], 'readOnly' => [], 'autoIncrement' => []];
        }
