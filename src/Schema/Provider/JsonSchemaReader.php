...
use JustQuery\Schema\Column\BooleanColumn;
use JustQuery\Schema\Column\ColumnInterface;
use JustQuery\Schema\Column\DoubleColumn;
use JustQuery\Schema\Column\IntegerColumn;
use JustQuery\Schema\Column\JsonColumn;
use JustQuery\Schema\Column\StringColumn;
