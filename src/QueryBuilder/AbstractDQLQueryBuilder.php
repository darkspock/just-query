...
use JustQuery\Expression\CompositeExpressionBuilder;
use JustQuery\Expression\Value\Param;
use JustQuery\Expression\Value\Builder\ParamBuilder;
use InvalidArgumentException;
use JustQuery\Exception\NotSupportedException;
use JustQuery\Expression\Value\ArrayValue;
use JustQuery\Expression\Value\Builder\ArrayValueBuilder;
use JustQuery\Expression\Value\ColumnName;
use JustQuery\Expression\Value\Builder\ColumnNameBuilder;
use JustQuery\Expression\Expression;
use JustQuery\Expression\ExpressionBuilder;
use JustQuery\Expression\ExpressionBuilderInterface;
use JustQuery\Expression\ExpressionInterface;
use JustQuery\Expression\Function\Builder\GreatestBuilder;
use JustQuery\Expression\Function\Builder\LeastBuilder;
use JustQuery\Expression\Function\Builder\LengthBuilder;
use JustQuery\Expression\Function\Builder\LongestBuilder;
use JustQuery\Expression\Function\Builder\ShortestBuilder;
...
use JustQuery\Expression\Value\Builder\JsonValueBuilder;
use JustQuery\Expression\Statement\CaseX;
use JustQuery\Expression\Statement\Builder\CaseXBuilder;
use JustQuery\Expression\Value\StructuredValue;
use JustQuery\Expression\Value\Builder\StructuredValueBuilder;
use JustQuery\Expression\Value\Value;
use JustQuery\Expression\Value\Builder\ValueBuilder;
use JustQuery\Expression\Value\DateTimeValue;
use JustQuery\Expression\Value\Builder\DateTimeValueBuilder;
...
use JustQuery\Query\QueryExpressionBuilder;
...
abstract class AbstractDQLQueryBuilder implements DQLQueryBuilderInterface
{
     ...
     * ```php
     * return [
     *     'LIKE' => \JustQuery\QueryBuilder\Condition\Like::class,
     * ];
     * ```
     *
    ...
    protected function defaultConditionClasses(): array
    {
        return [
            ...
            'JSON CONTAINS' => Condition\JsonContains::class,
            'JSON LENGTH' => Condition\JsonLength::class,
        ];
    }
