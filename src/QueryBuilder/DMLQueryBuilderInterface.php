...
interface DMLQueryBuilderInterface
{
     ...
     * @param array<int, string> $columns The column names of the table.
     * @param array<int|string, mixed> $params The binding parameters. This parameter exists.
     *
     * @throws Exception
     ...
     * @param array<string, mixed>|string $condition The condition to put in the `WHERE` part.
     * Please refer to {@see Query::where()} On how to specify condition.
     * @param array<int|string, mixed> $params The binding parameters to change by this method to bind to DB command later.
     *
     * @throws Exception
     * @throws InvalidArgumentException
     ...
     *
     * @param string $table The table to insert new rows into.
     * @param array<string, mixed>|QueryInterface $columns The column data (name => value) to insert into the table or instance of
     ...
     * @param array<string, mixed> $columns The column data (name => value) to update the table.
     ...
     * @param array<string, mixed>|ExpressionInterface|string|null $from The FROM part. Please refer to
     * {@see QueryPartsInterface::from()} On how to specify FROM part.
     * @param array<int|string, mixed> $params The binding parameters that will be modified by this method so that they can be bound to
     * DB command later.
     *
     * @throws Exception
     * @throws InvalidArgumentException
     ...
     * @param array<string, mixed>|QueryInterface $insertColumns The column data (name => value) to insert into the table or
     * instance of {@see Query} to perform `INSERT INTO ... SELECT` SQL statement.
     * @param array<string, mixed>|bool $updateColumns The column data (name => value) to update if they already exist. If `true`
     ...
     * @param array<int|string, mixed> $params The binding parameters that will be generated by this method. They should be bound to the DB
     * command later.
     *
     * @throws Exception
     * @throws InvalidConfigException
     ...
     * is passed, the column data will be updated to match the insert column data. If `false` is passed, no update will
     * be performed if the column data already exist.
     * @param array<int, string>|null $returnColumns The column names to return values from. `null` means all columns.
     * @param array<int|string, mixed> $params The binding parameters that will be generated by this method. They should be bound to the DB
     * command later.
     *
     * @throws Exception
