...
use FastPHP\QueryBuilder\Constraint\Index;
...
use FastPHP\QueryBuilder\Helper\DbArrayHelper;
...
abstract class AbstractDMLQueryBuilder implements DMLQueryBuilderInterface
{
    ...
    {
        [$names, $placeholders, $values, $params] = $this->prepareInsertValues($table, $columns, $params); // @phpstan-ignore parameterByRef.type
    ...
    protected function prepareBatchInsertValues(string $table, iterable $rows, array $columnNames, array &$params): array
    {
        ...
        foreach ($rows as $row) {
            ...
            foreach ($row as $key => $value) {
                ...
                $placeholders[$columnName] = $queryBuilder->buildValue($value, $params); // @phpstan-ignore parameterByRef.type
     ...
     * @throws NotSupportedException
     *
     * @return array<int, mixed> Array of column names, placeholders, values, and params.
     *
     * @psalm-param ParamsType $params
    ...
    protected function prepareInsertValues(string $table, array|QueryInterface $columns, array $params = []): array
    {
        ...
        $placeholders = [];
        $columns = $this->normalizeColumnNames($columns); // @phpstan-ignore argument.type
     ...
     * @param array<int, mixed>|null $updateNames
     * @param array<int|string, mixed> $params
     *
     ...
     *
     * @param array<string, mixed> $columns The column data (name => value).
     *
