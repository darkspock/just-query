...
use JustQuery\Constant\ColumnInfoSource;
use JustQuery\Constant\ColumnType;
use JustQuery\Constant\ReferentialAction;
use JustQuery\Constraint\ForeignKey;
use JustQuery\Constraint\Index;
use JustQuery\Driver\Pdo\AbstractPdoSchema;
...
final class Schema extends AbstractPdoSchema
{
    ...
    private function loadColumn(array $info): ColumnInterface
    {
        ...
        if (str_contains(strtolower($extra), 'generated') && !str_starts_with(strtolower($extra), 'default_generated')) {
            $column->computed();
        }
